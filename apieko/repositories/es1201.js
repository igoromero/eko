const Sensor = getmodule('models/es1201');
...
module.exports = {
    ...
    create: (data, cb) => {
        let info = {data: data.data, noid: data.noid, umidade: data.umidade, temperatura: data.temperatura, pontoOrvalho: data.pontoOrvalho};
